...
CREATE TABLE grades (
    id integer NOT NULL,
    std_github character varying(30),
    prj_title character varying(30),
    grade integer
);
...
COPY grades (id, std_github, prj_title, grade) FROM stdin;
1	jhacks	Markov	10
2	jhacks	Blockly	2
...
COPY students (id, fname, lname, github) FROM stdin;
